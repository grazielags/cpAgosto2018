...
public class Principal {
	...
	public static void cadastrarUsuario() throws SQLException {
		String nomeUsuario = JOptionPane.showInputDialog(null, "Nome do usuário.", "Cadastro de usuário",
				JOptionPane.DEFAULT_OPTION);
		String enderecoUsuario = JOptionPane.showInputDialog(null, "Endereço do usuário.", "Cadastro de usuário",
				JOptionPane.DEFAULT_OPTION);
